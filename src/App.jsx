  ...
  tariffs: [
    {
      ...
      price: '7 000 ₽',
      oldPrice: '10 000 ₽',
      features: ['Premium-шаблон из моей базы', 'Адаптация под ваш контент и цвета', 'Мини-апп в ТГ/ВК + веб-версия (PWA)', 'Поддомен имя.nice-app.ru навсегда', 'Создание Mini App', 'Бот + пост + запуск «под ключ»(в тг)', 'Запуск за 3-5 дней', 'Один платеж. Никаких подписок'],
    },
    {
      id: 'custom',
      title: 'Ultra',
      ...
      price: 'от 8 000 ₽',
      oldPrice: 'от 15 000 ₽',
      features: ['Уникальный дизайн и логика «с нуля»', 'Сложные 3D и WebGL эффекты', 'Мини-апп в ТГ/ВК + веб-версия (PWA)', 'Поддомен имя.nice-app.ru навсегда', 'Подключение вашего личного домена (помощь с покупкой и настройкой)', 'Создание Mini Apps', 'Бот + пост + запуск «под ключ»(в тг)', 'Запуск за 5-7 дней', 'Без аренды: Ваш личный цифровой актив навсегда'],
    }
  ],
